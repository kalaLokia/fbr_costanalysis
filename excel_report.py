"""
Creates designed a Cost Sheet file in xlsx.

Main package used: xlsxwritter.

Made by kalaLokia and Tony [ Nithin ;-) ]
...
class ExcelReporting:
    ...
    def writeConstantFields(self):
        ...
        self.worksheet.write(2, 2, self.article.artno.upper(), fmt_artinfo2)
        ...
        self.worksheet.write(
            self.pu_start_row - 2, 6, self.article.print_rate, fmt_textR
        )  # print
    ...
    def footer(self, fmt_B, fmt_BC, fmt_L, fmt_R):
        ...
        self.worksheet.write(end - 2, 6, self.article.basic_rate, fmt_BR)  # basic price
